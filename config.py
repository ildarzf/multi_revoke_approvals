...
SLEEP_REVOKE = [60, 120] # спим между кошельками в случае ревоука
SLEEP_CHK_ALLOW = 0.3 # задержка между кошельками на наличие апрува
UNLIM = 1500000 # смотрим и отменяем только контракты с апрувом выше 10 баксов USDC
TOKENS = {
    "ethereum": {
